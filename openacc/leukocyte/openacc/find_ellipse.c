...
#pragma acc kernels \
	...
	//private(i, j, k, n)
{
#pragma acc loop independent private(i, j, k, n) //gang(128) //(128), vector // gang(32), vector(32)
...
{
#pragma acc loop independent private(i, j, el_i, el_j) //gang(256) //independent
